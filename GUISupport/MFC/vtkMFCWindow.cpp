...
BOOL vtkMFCWindow::RegisterWindowClass(HINSTANCE hInstance)
{
    WNDCLASS windowclass;
    if (hInstance)
        hInstance = AfxGetInstanceHandle();
    if (!(::GetClassInfo(hInstance, VTKMFCWINDOW_CLASSNAME, &windowclass)))
    {
        ...
        windowclass.lpszClassName = VTKMFCWINDOW_CLASSNAME;
    }
    return AfxRegisterClass(&windowclass);
}

BOOL vtkMFCWindow::Create(DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext)
{
    return vtkMFCWindow::Create(VTKMFCWINDOW_CLASSNAME, NULL, dwStyle, rect, pParentWnd, nID, pContext);
}

BOOL vtkMFCWindow::Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT& rect, CWnd* pParentWnd, UINT nID, CCreateContext* pContext)
{
